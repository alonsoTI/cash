...
<html:form action="Orden.do" onsubmit="return false;">
	...
	<logic:equal value="SI" name="factibleEliminarOrden">
		<table cellpadding='2' cellspacing='2' border='0' align='center'
			width='90%' bordercolor='#0066CC'>
			<tr>
				<td class="TitleRow" colspan="2"><bean:write name='success'
					property='m_Mensaje' /></td>
			</tr>
			<logic:iterate name="alsuccess" id="beansuccess" indexId="j">
				<tr>
					<td class="CellColRow2" width="30%"><bean:write
						name="beansuccess" property="m_Label" /></td>
					<logic:notEmpty name="beansuccess" property="m_Mensaje">
						<td class="CellColRow2"><bean:write name="beansuccess"
							property="m_Mensaje" /></td>
					</logic:notEmpty>
					<logic:notEmpty name="beansuccess" property="m_MensajeArea">
						<td class="CellColRow2"><html:textarea name="beansuccess"
							property="m_MensajeArea" styleId="m_MensajeArea" rows="4"
							readonly="true" /></td>
					</logic:notEmpty>
				</tr>
			</logic:iterate>
	...
	<logic:equal value="NO" name="factibleEliminarOrden">
		<table cellpadding='2' cellspacing='2' border='0' align='center'
			width='90%' bordercolor='#0033CC'>
			<tr>
				<td class="TitleRow" colspan="2"><bean:write name='success'
					property='m_Mensaje' /></td>
			</tr>
	...
	<table cellpadding='2' cellspacing='2' border='0' align='center'
		...
		<tr>
			<td align='center'><img src="img/bt-volver.png" align="middle"
