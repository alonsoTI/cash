  ...
  <script language="JavaScript">
    ...
    function buscar(){
        ...
        if(validarFechasRelacionadas2(fecIni, fecFin)){
            frm.action = "letras.do?do=buscarPlanilla&from=3";
            frm.submit();
        }
    }
...
<html:form action="letras.do" onsubmit="return false;" >
  ...
  <table width="100%" CELLSPACING="0" CELLPADDING="4" border="0" >
    ...
    <table width="100%" cellpadding="2" cellspacing="2" border="0" align="center" >
	  ...
	  <td class='CellColRow2'>
	  	<html:select property="m_Empresa" styleClass="CellColRow">
  ...
  <logic:notEmpty name="listaResult">
      <layout:collection name="listaResult" title="letras.title.relacion.planilla" styleClass="FORM" id="letra" align="center" sortAction="client" width="100%">
      <layout:collectionItem title="letras.column.codigo.planilla" name="letra" property="m_Cuenta" sortable="true">
          <center>
              <layout:link href="letras.do?do=detallePlanillaLetras&from=3" name="letra" property="parametrosUrl" >
