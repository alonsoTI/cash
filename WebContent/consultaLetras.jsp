<%-- 
    Document   : consultaLetras
    Created on : 20/03/2009, 05:11:32 PM
    Author     : jmoreno
    pruebas letras
--%>
  ...
  <script language="JavaScript">
    ...
    function buscar(){
      ...
      if(validarFechasRelacionadas2(fecIni, fecFin)){
        frm.action = "letras.do?do=buscarPlanilla&from=1";
        frm.submit();
      }
    }
...
<html:form action="letras.do">
  ...
  <table width="100%" CELLSPACING="0" CELLPADDING="4" border="0" >
    <tr>
      <td valign="middle" align="left" colspan="4" class="Title"><bean:message key="letras.title.consulta"/></td>
	</tr>
  </table>
  ...
  <logic:notEmpty name="listaResult">
      ...
      <layout:collectionItem title="letras.column.codigo.planilla" name="letra" property="m_Cuenta" sortable="true" >
          <center>
              <layout:link href="letras.do?do=detallePlanillaLetrasPag&from=1" name="letra" property="parametrosUrl">
