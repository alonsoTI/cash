<%-- 
    Document   : detallePagoOnline
    Created on : 30-mar-2009, 10:09:18
    Author     : jwong
--%>
  ...
  <script language="JavaScript">
    ...
    function aceptar(){
        ...
        //if(validarMontoCuenta()){
            ...
            frm.action = "pagoServicio.do?do=pagarOnLine";
            frm.submit();
        /*
        }
        else{
	...
	function cancelar(){
		location.href = "pagoServicio.do?do=buscarPagoOnLine&"+document.forms[0].data.value;//"pagoOnLine.jsp";
	}
    /*
...
<html:form action="pagoServicio.do">
  ...
  <table width="100%" cellpadding="2" cellspacing="2" border="0" >
    ...
    <tr>
      <td class="TitleRow2" width="25%" ><bean:write property="m_LabelNumAbonado" name="serv_pago"/></td>
      <td class="CellColRow2" width="75%">
    ...
    <tr>
      ...
      <td class="CellColRow2">
        <html:text property="m_Referencia" styleId="m_Referencia" size="50" maxlength="50" value="" styleClass="CellColRow8" onkeypress="return soloDescripcion(this,event)" onblur="gDescripcion(this)"/>
      </td>
    </tr>
