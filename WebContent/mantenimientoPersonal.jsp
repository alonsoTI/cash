...
<head>
  ...
  <link rel="stylesheet" href="tyni/styleTyni.css" />
  ...
  <script language="JavaScript">
    ...
    function buscar(){
        ...
        if(frm.m_IdServEmp.value != null && ""!=frm.m_IdServEmp.value){
            frm.action = "administracion.do?do=buscarPersonal";
            frm.submit();
        }else{
    ...
    function nuevo(){
		var frm = document.forms[0];
        if(frm.m_IdServEmp.value != null && ""!=frm.m_IdServEmp.value){
            frm.action = "personal.do?do=nuevoPersonal&m_IdServEmp="+frm.m_IdServEmp.value;
            frm.submit();
        }else{
            alert("No existe servicios afiliados");
        }
    ...
    function obtenerServicios(){        
        var frm = document.forms[0];
        frm.action = "administracion.do?do=cargarServiciosPersonal";
        frm.submit();
    }
...
<logic:equal name="habil" value="1">
  ...
  <table width="100%" cellpadding="2" cellspacing="2" border="0" >
    <tr>
      ...
      <td class="CellColRow">Servicios:</td>
      <td class='CellColRow2'>
  ...
  <br>
  <logic:notEmpty name="listaPersonal">
    <layout:collection name="listaPersonal" title="DETALLE DE PERSONAL" styleClass="FORM" id="empleado" sortAction="client" width="100%" align="center">
      <layout:collectionItem title="ID Empleado" sortable="true">
        <center>
        <layout:link href="personal.do?do=cargarModificarPersonal" name="empleado" property="parametrosUrl">
            <layout:write name="empleado" property="id.ceeidEntidad"/>
        </layout:link>
        </center>
      </layout:collectionItem>
      
      <layout:collectionItem title="Nombre" property="deenombre" sortable="true"/>
      ...
      <layout:collectionItem title="Celular" property="deetelefono" sortable="true"/>
      <layout:collectionItem title="Email" property="deeemail" />
    </layout:collection>

    <div id="comp1" style="display:none">ANS</div>
    <div id="comp2" style="display:none">ANS</div>
    <div id="comp3" style="display:none">NUM</div>
    <div id="comp4" style="display:none">NUM</div>
  </logic:notEmpty>
