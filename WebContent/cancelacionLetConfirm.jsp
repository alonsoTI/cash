<%-- 
    Document   : cancelacionLetConfirm
    Created on : 24/03/2009, 10:53:53 AM
    Author     : jmoreno
--%>
    ...
    <head>
        ...
        <script language="JavaScript" type="text/JavaScript">
            function back(){
                ...
                var url = "letras.do?do=cargarCancelacion";
                frm.action = url;
                frm.submit();
            }
        </script>
    ...
    <body>
        <html:form action="letras.do" onsubmit="return false;" >
            <table width="100%" CELLSPACING="0" CELLPADDING="4" class="Title" >
                <tr>
                    <td valign="middle" align="left" ><bean:message key="letras.title.cancelacion"/></td>
                </tr>
                <tr>
            ...
            <table cellpadding='2' cellspacing='2' border='0' align='center' width='90%' bordercolor='#0066CC'>
                ...
                <logic:iterate name="alsuccess" id="beansuccess" indexId="j">
                    <tr>
                        ...
                        <td class="CellColRow2"><html:textarea name="beansuccess" property="m_MensajeArea" /></td>
                        </logic:notEmpty>
                    </tr>
                </logic:iterate>
                <tr><td><br></td></tr>
