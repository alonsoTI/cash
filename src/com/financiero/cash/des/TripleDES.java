package com.financiero.cash.des;
    ...
    private String HP_3DES(int tipo, String Data_in, String key1, String key2, String key3)
    {
        ...
        try
        {
            while(posicion < data_in_len)
            {
                ...
                if(input.length()<16) while(input.length()<16) input = input.concat("F");
...
//                    System.out.println("OUTPUT 33: "+output.toUpperCase()+"\n");
    ...
    public static String encriptar(String texto){
         ...
         output = tdes.cipher(texto, key1, key2 , key3);
         
         return tdes.toHexString(output);
    }
}
